...
PCTracking::PCTracking(ros::Publisher* _pub_scene, ros::Publisher* _pub_model, FuncPub _funcPub, double cont_sampling, double cont_simplify, int cont_window)
{
    pub_scene = _pub_scene;
    pub_model = _pub_model;
    funcPub = _funcPub;
    tracks = new PCTrackContainer(100);
    imft = new IMFT<PCObject>(cont_window, cont_window+10, 100, &weight_l2_rev, &weight_l2_rev);
