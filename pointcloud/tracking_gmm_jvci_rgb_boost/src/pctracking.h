...
typedef vector< shared_ptr<PCObject> > VecObjectPtr;
...
private:
    ...
    void trackingGaussians(shared_ptr<PCObject> object, CloudPtr observedPoints, PCObjectContainer& updatedObjects);
