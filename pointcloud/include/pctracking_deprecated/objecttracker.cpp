...
ObjectTracker<Ptr>::ObjectTracker(int nWindow, bool isDebug) : Parent(nWindow, isDebug)
{
}

template<typename Ptr>
double ObjectTracker<Ptr>::gain(V pNode, V cNode, double alpha)
{
...
template<typename Ptr>
double ObjectTracker<Ptr>::gain(Ptr pPtr, Ptr cPtr, double alpha)
{
...
template<typename Ptr>
void ObjectTracker<Ptr>::eraseLastFrame()
{
    int cnt = Parent::cnt;
...
template<typename Ptr>
void ObjectTracker<Ptr>::twoFrameMatching(VecPtr frame1, VecPtr frame2)
{
    Parent::cnt = 1;
...
template<typename Ptr>
void ObjectTracker<Ptr>::confirmDGraph()
{
