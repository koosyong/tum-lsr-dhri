...
/**
* \file gmmreg_grbf.cpp
* \brief  The implementation of the class gmmreg_grbf
*/
...
void gmmreg_grbf::grbfInit(int _level, char* _sigma, char* _max_function_evals, char* _lamda, char* _fix_affine)
{

}

void gmmreg_grbf::prepare_own_options(int level, char* sigma, char* max_function_evals, char* lamda, char* fix_affine)
{
...
void gmmreg_grbf::save_results(const char* f_config, const vnl_vector<double>& params) {
