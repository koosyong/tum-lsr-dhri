#ifndef TOMPOINTTRACKER_H
#define TOMPOINTTRACKER_H
...
class TOMPointTracker : public IMFT<Ptr>
{
public:    
    ...
    TOMPointTracker(int nWindow, bool isDebug = 0);
