#ifndef TOMOBJECTTRACKER_H
#define TOMOBJECTTRACKER_H
...
class TOMObjectTracker : public IMFT<Ptr>
{
public:
...
public:
    TOMObjectTracker(int nWindow, bool isDebug = 0);
